...
const app = new Hono<{ Bindings: { PORTFOLIO_KV: KVNamespace; JWT_SECRET: string; BASE_URL?: string; GOOGLE_CLIENT_ID?: string; GOOGLE_CLIENT_SECRET?: string; GITHUB_CLIENT_ID?: string; GITHUB_CLIENT_SECRET?: string } }>()
app.use('*', logger())
