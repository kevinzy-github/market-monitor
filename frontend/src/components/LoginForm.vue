  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center px-4">
    <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
      ...
      <div class="flex gap-3 mb-2">
        <a href="/api/auth/oauth/google" class="flex-1 flex items-center justify-center gap-2 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all text-sm font-medium text-gray-700 no-underline">
        ...
        <a href="/api/auth/oauth/github" class="flex-1 flex items-center justify-center gap-2 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-800 hover:text-white hover:border-gray-800 transition-all text-sm font-medium text-gray-700 no-underline">
